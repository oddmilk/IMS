...
# read in data
DF_ID = pd.read_excel('/Users/mengjichen/Desktop/MI.xlsx', "Sheet1")
...
# add group numbers to the data fram
DF = DF_ID
...
writer = ExcelWriter('/Users/mengjichen/Desktop/iView_Process/20161122_MI_Flattened.xlsx')
